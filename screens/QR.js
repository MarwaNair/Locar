...
import { Image, Animated, Text, View, Dimensions, StyleSheet, TouchableOpacity,} from 'react-native';
...
export default function QR( { navigation }) {
  const { user } = useUser();
    ...
    <View style={styles.container}>
      ...
      style={{height:20,width:20, marginLeft:370 , marginTop:hp('1.5%'),} }/>
     </TouchableOpacity >
      <Image 
      ...
      <Text style={styles.voiture}> {user.email}
      </Text>
      </View>
    ...
    <Text style={{fontFamily: 'Montserrat-Bold', color:'#000', fontSize:wp('7%'),marginTop: '10%',marginBottom: '5%',}}> Ajouter une voiture
      </Text>
      <Text style={{fontFamily: 'Montserrat-Regular', color:'#000', fontSize:wp('6%'),marginBottom: '7%',}}> Scanner le code QR
      </Text>
